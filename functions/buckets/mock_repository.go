...
func (m *MockRepository) CreateOrUpdate(arg0 context.Context, arg1 Bucket) error {
	m.ctrl.T.Helper()
...
func (m *MockRepository) FindById(arg0 context.Context, arg1, arg2 string) (*Bucket, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) FindByName(arg0 context.Context, arg1, arg2 string) (*Bucket, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Search(arg0 context.Context, arg1 SearchContext) ([]Bucket, error) {
	m.ctrl.T.Helper()
