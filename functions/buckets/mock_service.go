...
func (m *MockService) Create(arg0 context.Context, arg1 string, arg2 Bucket) (string, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) FindById(arg0 context.Context, arg1, arg2 string) (*Bucket, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Search(arg0 context.Context, arg1 SearchContext) ([]Bucket, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Update(arg0 context.Context, arg1 string, arg2 Bucket) error {
	m.ctrl.T.Helper()
